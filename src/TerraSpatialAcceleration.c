...
/*
    Available acceleration structures
    #define (flags, work for some algorithm)
        terra_acceleration_bvh_stackless[Wald 2011]

    #define ... 1
        terra_acceleration_bvh[]
        terra_acceleration_multi_branching_bvh[Wald 2008]
    ...
    High-level stackless BVH single ray traversal:
